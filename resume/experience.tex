...
%---------------------------------------------------------
  \cventry
    ...
    {
      \begin{cvitems} % Description(s) of tasks/responsibilities
        \item {Member of two international groups responsible for monitoring HCAL operations and performance studies}
        ...
        %% \item {Parametrized and characterized the raw pulse shapes in different parts of the detector which is now part of the official CMS simulation framework}
      \end{cvitems}
    }
